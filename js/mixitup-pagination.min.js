...
(function (window) {
  ...
  var mixitupPagination = function (mixitup) {
    ...
    mixitup.ConfigClassNames.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        /**
    ...
    mixitup.ConfigLoad.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        /**
    ...
    mixitup.ConfigRender.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        /**
    ...
    mixitup.ConfigSelectors.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        /**
    ...
    mixitup.ConfigTemplates.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        /**
    ...
    mixitup.UiClassNames.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        this.first = "";
    ...
    mixitup.controlDefinitions.push(
      new mixitup.ControlDefinition("pager", "[data-page]", true, "pageListEls")
    );
    ...
    mixitup.Control.registerFilter(
      "commandsHandleClick",
      "pagination",
      function (commands, e) {
        var self = this,
        ...
        for (i = 0; (mixer = self.bound[i]); i++) {
          ...
          if (
            !mixer.config.pagination ||
            mixer.config.pagination.limit < 0 ||
            mixer.config.pagination.limit === Infinity
          ) {
          ...
          if (
            !button ||
            h.hasClass(button, mixer.classNamesPager.active) ||
            h.hasClass(button, mixer.classNamesPager.disabled)
          ) {
    ...
    mixitup.CommandMultimix.registerAction(
      "afterConstruct",
      "pagination",
      function () {
        this.paginate = null;
    ...
    mixitup.Operation.registerAction(
      "afterConstruct",
      "pagination",
      function () {
    ...
    mixitup.Mixer.registerAction("afterAttach", "pagination", function () {
      ...
      // jscs:disable
      self.classNamesPager.base = h.getClassname(
        self.config.classNames,
        "pager"
      );
      self.classNamesPager.active = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierActive
      );
      self.classNamesPager.disabled = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierDisabled
      );
      self.classNamesPager.first = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierFirst
      );
      self.classNamesPager.last = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierLast
      );
      self.classNamesPager.prev = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierPrev
      );
      self.classNamesPager.next = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierNext
      );
      self.classNamesPager.truncationMarker = h.getClassname(
        self.config.classNames,
        "pager",
        self.config.classNames.modifierTruncationMarker
      );

      self.classNamesPageList.base = h.getClassname(
        self.config.classNames,
        "page-list"
      );
      self.classNamesPageList.disabled = h.getClassname(
        self.config.classNames,
        "page-list",
        self.config.classNames.modifierDisabled
      );

      self.classNamesPageStats.base = h.getClassname(
        self.config.classNames,
        "page-stats"
      );
      self.classNamesPageStats.disabled = h.getClassname(
        self.config.classNames,
        "page-stats",
        self.config.classNames.modifierDisabled
      );
      ...
      if (
        self.config.pagination.generatePageList &&
        self.dom.pageListEls.length > 0
      ) {
      ...
      if (
        self.config.pagination.generatePageStats &&
        self.dom.pageStatsEls.length > 0
      ) {
    ...
    mixitup.Mixer.registerAction(
      ...
      function () {
        ...
        if (typeof self.config.pagination.maxPagers === "number") {
          ...
          self.config.pagination.maxPagers = Math.max(
            5,
    ...
    mixitup.Mixer.registerAction("afterCacheDom", "pagination", function () {
      ...
      self.dom.pageListEls = parent.querySelectorAll(
        self.config.selectors.pageList
      );
      self.dom.pageStatsEls = parent.querySelectorAll(
        self.config.selectors.pageStats
      );
    });
    ...
    mixitup.Mixer.registerFilter("stateBuildState", "pagination", function (
      state,
      operation
    ) {
      var self = this;
    ...
    mixitup.Mixer.registerFilter(
      ...
      function (instruction) {
        ...
        if (
          instruction.command.paginate &&
          !(instruction.command.paginate instanceof mixitup.CommandPaginate)
        ) {
          instruction.command.paginate = self.parsePaginateArgs([
            instruction.command.paginate,
          ]).command;
        }
    ...
    mixitup.Mixer.registerAction(
      ...
      function (operation) {
        ...
        operation.newTotalPages = operation.newPagination.limit
          ? Math.max(
              Math.ceil(
                operation.matching.length / operation.newPagination.limit
              ),
              1
            )
          : 1;
        ...
        if (self.config.pagination.maintainActivePage) {
          operation.newPagination.page =
            operation.newPagination.page > operation.newTotalPages
        ...
        if (operation.newPagination.anchor) {
          ...
          startPageAt =
            operation.newPagination.limit * (operation.newPagination.page - 1);
          endPageAt =
            operation.newPagination.limit * operation.newPagination.page - 1;
    ...
    mixitup.Mixer.registerFilter(
      ...
      "pagination",
      function (operation, command, isPreFetch) {
        var self = this,
          el = null,
          i = -1;
    ...
    mixitup.Mixer.extend(
      /** @lends mixitup.Mixer */
      {
        ...
        parsePaginateCommand: function (command, operation) {
          ...
          if (command.page > -1) {
            if (command.page === 0)
              throw new Error(mixitup.messages.ERROR_PAGINATE_INDEX_RANGE);

            // TODO: replace Infinity with the highest possible page index

            operation.newPagination.page = Math.max(
              1,
              Math.min(Infinity, command.page)
            );
          ...
          if (
            ...
            operation.newTotalPages = operation.newPagination.limit
              ? Math.max(
                  Math.ceil(
                    operation.startState.matching.length /
                      operation.newPagination.limit
                  ),
                  1
                )
              : 1;
        ...
        getNextPage: function () {
          ...
          if (page > self.state.totalPages) {
            page = self.config.pagination.loop
              ? 1
              : self.state.activePagination.page;
          }
        ...
        renderPageListEl: function (pageListEl, operation) {
          ...
          if (
            operation.newPagination.limit < 0 ||
            operation.newPagination.limit === Infinity ||
            (operation.newTotalPages < 2 &&
              self.config.pagination.hidePageListIfSinglePage)
          ) {
          ...
          renderer =
            typeof (renderer = self.config.render.pager) === "function"
              ? renderer
              : null;

          if (
            self.config.pagination.maxPagers < Infinity &&
            operation.newTotalPages > self.config.pagination.maxPagers
          ) {
          ...
          model.isPrev = true;
          model.classList.push(
            self.classNamesPager.base,
            self.classNamesPager.prev
          );
          ...
          for (i = 0; i < operation.newTotalPages; i++) {
            ...
            if (
              pagerHtml ||
              (i < activeIndex && truncatedBefore) ||
              (i > activeIndex && truncatedAfter)
            ) {
              if (pagerHtml) {
                buttonList.push(pagerHtml);
              }
            ...
            model.classList.push(
              self.classNamesPager.base,
              self.classNamesPager.truncationMarker
            );
            model.classNames = model.classList.join(" ");
            ...
            if (renderer) {
              ...
              pagerHtml = h.template(
                self.config.templates.pagerTruncationMarker
              )(model);
            }
          ...
          disabled = pageListEl.querySelectorAll(
            "." + self.classNamesPager.disabled
          );
        ...
        renderPageStatsEl: function (pageStatsEl, operation) {
          ...
          if (
            ...
            operation.newPagination.limit === Infinity ||
            (operation.newTotalPages < 2 &&
              self.config.pagination.hidePageStatsIfSinglePage)
          ) {
            // Empty the pager list, and add disabled class
          ...
          renderer =
            typeof (renderer = self.config.render.pageStats) === "function"
              ? renderer
              : null;
          ...
          if (model.totalTargets) {
            template =
              operation.newPagination.limit === 1
          ...
          if (model.totalTargets && operation.newPagination.limit > 0) {
            model.startPageAt =
              (operation.newPagination.page - 1) *
                operation.newPagination.limit +
              1;
            model.endPageAt = Math.min(
              model.startPageAt + operation.newPagination.limit - 1,
              model.totalTargets
            );
          } else {
        ...
        parsePaginateArgs: function (args) {
          ...
          for (i = 0; i < args.length; i++) {
            ...
            if (
              ...
              arg instanceof mixitup.CommandPaginate ||
              typeof arg === "object"
            ) {
    ...
    mixitup.Facade.registerAction("afterConstruct", "pagination", function (
      mixer
    ) {
